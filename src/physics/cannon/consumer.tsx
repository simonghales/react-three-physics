...
import {CannonBuffersData, generateCannonBuffers} from "./buffers";
...
const mapBufferDataToObjectRef = (buffers: CannonBuffersData, index: number, objectRef: MutableRefObject<Object3D>) => {
...
export const CannonPhysicsConsumer: React.FC<{
    worker: Worker,
    maxNumberOfPhysicsObjects?: number,
    stepRate?: number,
}> = ({maxNumberOfPhysicsObjects = DEFAULT_NUMBER_OF_PHYSICS_OBJECTS, ...props}) => {

    const [buffers] = useState(() => generateCannonBuffers(maxNumberOfPhysicsObjects))
